...
health_control <- fread("220127_feature_matrix_no_bert_health_comparator.csv") %>% clean_names()
...
nonzero_model_health_control_to_export %>%
  ...
  labs(x = "Topic",
       ...
       title = "Standardized Coefficient of Semicontinuous Hurdle Models (Health Control)")
setwd("~/Documents/dartmouth/research/aim3_facebook_covid19_obesity/figures")
ggsave("220131_standardized_hurdle_health_control.tiff",
       width = 8.5,
       height = 5.29)
```
