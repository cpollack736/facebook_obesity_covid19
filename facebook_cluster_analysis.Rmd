...
obesity_topics <- fread("220314_obesity_with_topics.csv") %>%
  clean_names()
```
...
obesity_topics %<>%
  filter(topics >= 1 & topics <= 11 & topics != 4) #34,868 posts
...
obesity_topics %>%
  ...
  mutate(topic_renamed = factor(topic_renamed,
                                    levels = c("Topic: 1", "Topic: 2", "Topic: 3", "Topic: 5", "Topic: 6", "Topic: 7", "Topic: 8", "Topic: 9", "Topic: 10", "Topic: 11")),
         topics_facet = case_when(
           topic_renamed == "Topic: 1" ~ "Bariatric Surgery",
           topic_renamed == "Topic: 2" ~ "Sleep",
           topic_renamed == "Topic: 3" ~ "Keto Diet",
           topic_renamed == "Topic: 5" ~ "COVID-19-a",
           topic_renamed == "Topic: 6" ~ "COVID-19-b",
           topic_renamed == "Topic: 7" ~ "Clickbait",
           topic_renamed == "Topic: 8"~ "Weight Loss Stories",
           topic_renamed == "Topic: 9" ~ "COVID-19 Vaccinations",
           topic_renamed == "Topic: 10" ~ "Childhood Obesity",
           topic_renamed == "Topic: 11" ~ "Type 2 Diabetes"
         )) %>%
...
setwd("~/Documents/dartmouth/research/aim3_facebook_covid19_obesity/figures")
ggsave("220315_topics_per_day_facet.tiff",
       width = 7.25, 
       height = 4.51)
```
...
dfs <- c("topics_per_day_1", "topics_per_day_2", "topics_per_day_3", "topics_per_day_5", "topics_per_day_6", "topics_per_day_7", "topics_per_day_8", "topics_per_day_9", "topics_per_day_10", "topics_per_day_11")
```
...
for (df in dfs) {
  for (d in list_of_its_dates) {
    if (d == 18281 & df %in% c("topics_per_day_5", "topics_per_day_6", "topics_per_day_9") | d == 18332 & df == "topics_per_day_9" | d == 18401 & df == "topics_per_day_9" | d == 18537 & df == "topics_per_day_9") {
      next
    }
    print(as.Date(d))
    print(df)
...
for (df in dfs) {
  ...
  r = FALSE
  s = FALSE
  if (df %in% c("topics_per_day_3", "topics_per_day_7", "topics_per_day_8", "topics_per_day_11")) {
    p = TRUE
  }
  if (df %in% c("topics_per_day_1", "topics_per_day_2", "topics_per_day_10")) {
    s = TRUE
  }
...
for (df in dfs) {
  ...
  if (df %in% c("topics_per_day_1", "topics_per_day_2", "topics_per_day_3", "topics_per_day_6", "topics_per_day_7")) {
    s = TRUE
  }
  if (df %in% c("topics_per_day_2", "topics_per_day_8", "topics_per_day_10")) {
    r = TRUE
  }
...
for (df in dfs) {
  ...
  r = FALSE
  s = FALSE
  if (df %in% c("topics_per_day_3", "topics_per_day_6")) {
    p = TRUE
  }
  if (df %in% c("topics_per_day_1", "topics_per_day_2", "topics_per_day_5", "topics_per_day_7", "topics_per_day_8", "topics_per_day_10", "topics_per_day_11")) {
    s = TRUE
  }
  if (df %in% c("topics_per_day_5", "topics_per_day_11")) {
    r = TRUE
  }
...
for (df in dfs) {
  ...
  r = FALSE
  s = FALSE
  if (df %in% c("topics_per_day_2", "topics_per_day_5", "topics_per_day_6", "topics_per_day_8")) {
    p = TRUE
  }
  if (df %in% c("topics_per_day_8", "topics_per_day_10")) {
    s = TRUE
  }
  if (df %in% c("topics_per_day_1", "topics_per_day_2", "topics_per_day_3", "topics_per_day_5", "topics_per_day_7", "topics_per_day_8", "topics_per_day_11")) {
    r = TRUE
  }
