...
obesity_topics <- fread("220304_obesity_with_topics.csv") %>%
```
...
obesity_topics %<>%
  filter(topics >= 1 & topics <= 11 & topics != 2) #17,907 posts
...
obesity_topics %>%
  ...
  mutate(topic_renamed = factor(topic_renamed,
                                    levels = c("Topic: 1", "Topic: 3", "Topic: 4", "Topic: 5", "Topic: 6", "Topic: 7", "Topic: 8", "Topic: 9", "Topic: 10", "Topic: 11"))) %>%
...
setwd("~/Documents/dartmouth/research/aim3_facebook_covid19_obesity/figures")
ggsave("220304_topics_per_day_facet.tiff",
       width = 7.25, 
       height = 4.51)
```
...
dfs <- c("topics_per_day_1", "topics_per_day_3", "topics_per_day_4", "topics_per_day_5", "topics_per_day_6", "topics_per_day_7", "topics_per_day_8", "topics_per_day_9", "topics_per_day_10", "topics_per_day_11")
```
...
for (df in c("topics_per_day_3", "topics_per_day_8")) {
  ...
  #January 20th
  if (df %in% c("topics_per_day_5", "topics_per_day_6", "topics_per_day_8")) {
    df_loop$pulse <- ifelse(df_loop$post_created_date == as.Date("2020-01-20"), 
                            1, 
                            df_loop$pulse)
  } 
  
  if (df %in% c("topics_per_day_1", "topics_per_day_3", "topics_per_day_10")) {
  ...
  if (df %in% c("topics_per_day_4", "topics_per_day_7", "topics_per_day_9", "topics_per_day_10", "topics_per_day_11")) {
  ...
  #March 11th
  if (df %in% c("topics_per_day_1", "topics_per_day_6", "topics_per_day_8")) {
    df_loop$pulse <- ifelse(df_loop$post_created_date == as.Date("2020-03-11"), 
                            1, 
                            df_loop$pulse)
  } 
  
  if (df %in% c("topics_per_day_3", "topics_per_day_4", "topics_per_day_5", "topics_per_day_7", "topics_per_day_10", "topics_per_day_11")) {
  ...
  #May 19th
  if (df %in% c("topics_per_day_1", "topics_per_day_3", "topics_per_day_9", "topics_per_day_10")) {
    df_loop$pulse <- ifelse(df_loop$post_created_date == as.Date("2020-05-19"), 
                            1, 
                            df_loop$pulse)
  } 
  
  if (df %in% c("topics_per_day_4", "topics_per_day_5", "topics_per_day_7", "topics_per_day_8")) {
  ...
  if (df %in% c("topics_per_day_5", "topics_per_day_6", "topics_per_day_11")) {
  ...
  #October 2nd
  if (df %in% c("topics_per_day_1", "topics_per_day_4", "topics_per_day_7", "topics_per_day_8", "topics_per_day_9")) {
    df_loop$pulse <- ifelse(df_loop$post_created_date == as.Date("2020-10-02"), 
                            1, 
                            df_loop$pulse)
  } 
  
  if (df %in% c("topics_per_day_1", "topics_per_day_5", "topics_per_day_10")) {
  ...
  if (df %in% c("topics_per_day_2", "topics_per_day_3", "topics_per_day_5", "topics_per_day_6", "topics_per_day_11")) {
