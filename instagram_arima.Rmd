...
obesity_instagram <- fread("220330_instagram_data_english_only.csv") %>%
  clean_names()
...
## Plotting
```{r}
obesity_count_per_day_instagram %>%
  ...
  labs(x = "Date",
       y = "Posts per Day",
       title = "Distribution of Posts per Day Around Major News Stories - Instagram") +
  theme(legend.position = "none")
setwd("~/Documents/dartmouth/research/aim3_facebook_covid19_obesity/figures")
ggsave("220403_interactions_per_day_instagram_facet.tiff",
       width = 7.25, 
       height = 4.51)
```
...
- March 11th: Lag 3 Obesity
- May 19th: Lag 1 Obesity
...
obesity_interaction_per_day %>%
  ...
  labs(x = "Date",
       ...
       title = "Distribution of Interactions per Day Around Major News Stories - Instagram") +
  theme(legend.position = "none")
setwd("~/Documents/dartmouth/research/aim3_facebook_covid19_obesity/figures")
ggsave("220403_interactions_per_day_instagram_facet.tiff",
       width = 7.25, 
